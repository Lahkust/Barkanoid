...
//Description :		Ce programme affiche une image qui réagit à certains événements : il est possible de 
//					déplacer cette image en fonction du mouvement de la souris ou de certaines touches du clavier
...
//  else
//  {
//	//On définit la taille du rectangle qui définira la taille de la texture 'redGhostTexture'
//	redGhostRect.x = 0;
//	redGhostRect.y = 0;
